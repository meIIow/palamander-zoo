...
const segmentatePair: SegmentationFunc = (
  parent: Segment,
  section: Section,
): Segment[] => {
  ...
  const flippedAngle =
    parent.bodyAngle.relative - (next.angle - parent.bodyAngle.relative);
...
const segmentateEqual: SegmentationFunc = (
  _parent: Segment,
  section: Section,
): Segment[] => {
  if (section.next == null) return [];
...
const segmentateRadial: SegmentationFunc = (
  _parent: Segment,
  section: Section,
): Segment[] => {
  if (section.next == null) return [];
