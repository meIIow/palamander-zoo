...
export const pals = {
  axolittl: segmentateAxolotl,
  munchkin: segmentateCaterpillar,
  decipede: segmentateCentipede,
  crawpa: segmentateCrawdad,
  prince: segmentateFrog,
  jelly: segmentateJellyfish,
  'bocce-crab': segmentateHorshoeCrab,
  nautilus: segmentateNautilus,
  palamander: segmentateNewt,
  'newt-king': segmentateNewtKing,
  hexapus: segmentateOctopus,
  'sea-lion': segmentateSeaLion,
  'sea-monkey': segmentateSeaMonkey,
  serpent: segmentateSnake,
  novafish: segmentateStarfish,
  pollywog: segmentateTadpole,
  wyrm: segmentateWyrm,
};
